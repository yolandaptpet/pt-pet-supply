const id = "test-blog-post1.md";
						const collection = "blog";
						const slug = "test-blog-post1";
						...
						const data = {title:"Test Blog Post - 40 Character Maximum",description:"Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et ma",publishDate:new Date(1728000000000),tags:["Store News","Promo"]};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/digga/pt-pet-supply/src/content/blog/test-blog-post1.md",
							rawData: undefined,
						};
