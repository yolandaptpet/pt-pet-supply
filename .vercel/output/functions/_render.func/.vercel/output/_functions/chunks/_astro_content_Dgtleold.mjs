...
const mapPin = new Proxy({"src":"/_astro/map-pin.CDyWTPmY.png","width":426,"height":679,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/digga/pt-pet-supply/src/assets/map-pin.png";
							}
...
const openSignBackground = new Proxy({"src":"/_astro/openclose.Dy3MoZyR.png","width":691,"height":230,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/digga/pt-pet-supply/src/assets/openclose.png";
							}
...
let lookupMap = {};
lookupMap = {"blog":{"type":"content","entries":{"test-blog-post10":"/src/content/blog/test-blog-post10.md","test-blog-post1":"/src/content/blog/test-blog-post1.md","test-blog-post4":"/src/content/blog/test-blog-post4.md","test-blog-post11":"/src/content/blog/test-blog-post11.md","test-blog-post2":"/src/content/blog/test-blog-post2.md","test-blog-post3":"/src/content/blog/test-blog-post3.md","test-blog-post5":"/src/content/blog/test-blog-post5.md","test-blog-post7":"/src/content/blog/test-blog-post7.md","test-blog-post6":"/src/content/blog/test-blog-post6.md","test-blog-post8":"/src/content/blog/test-blog-post8.md","test-blog-post9":"/src/content/blog/test-blog-post9.md"}}};
